...
public struct Vector3 : IFlatbufferObject
{
  ...
  public static Offset<bow.data.Vector3> CreateVector3(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f,
      float z = 0.0f) {
  ...
  public static Offset<bow.data.Vector3> EndVector3(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<bow.data.Vector3>(o);
  }
}
